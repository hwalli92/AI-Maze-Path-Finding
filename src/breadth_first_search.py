...
def breadth_first_search(maze_map, start_pos, goal_pos, file):
...
if __name__ == "__main__":
    ...
    solution_map1 = breadth_first_search(
        maze_map_tree1, start_pos_map1, goal_pos_map1, "results/bfs_map1.txt"
    )
    ...
    solution_map2 = breadth_first_search(
        maze_map_tree2, start_pos_map2, goal_pos_map2, "results/bfs_map2.txt"
    )
    ...
    solution_map3 = breadth_first_search(
        maze_map_tree3, start_pos_map3, goal_pos_map3, "results/bfs_map3.txt"
    )
